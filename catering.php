...
if ((($mcat == 'merienda') AND ( $nopax > 99)) OR ( ($mcat == 'lunch_and_dinner')AND ( $nopax > 49)) OR ( ($mcat == 'specialty') AND ( $nopax > 29))) {
    ...
    header("location: index.php?ask=" . base64_encode('portal') . "&res=$resid&mcat=$mcat&additional=$addd");
}
...
if (($mcat == 'merienda')AND ( $nopax < 100)) {
    ...
    echo '<a href="index.php?ask=' . base64_encode('reservation') . '">Back</a>';
}
