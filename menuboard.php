...
<div style="width:800px;"
            ...
            <div style="float:left; width: 395px; margin-right:10px;">
                <fieldset>
                    ...
                    for ($i = 0; $rows = $result->fetch(); $i++) {
                        ?>
                        <input type="checkbox" name="menu[]" value="<?php echo $rows['id'] ?>" style="width: 16px;"><a style="text-decoration: none; color: #000000;" href="#" onClick="MyWindow = window.open('details.php?id=<?php echo $rows['id'] ?>', 'MyWindow', 'toolbar=no,location=no,directories=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=500,height=500');
                                        return false;"><?php echo $rows['name'] ?></a><br>
                                                                                                                       <?php
                                                                                                                   }
                                                                                                                   ?>
                </fieldset>
                <fieldset>
                    ...
                    for ($i = 0; $rows = $result->fetch(); $i++) {
                        ?>
                        <input type="checkbox" name="menu[]" value="<?php echo $rows['id'] ?>"><a style="text-decoration: none; color: #000000;" href="#" onClick="MyWindow = window.open('details.php?id=<?php echo $rows['id'] ?>', 'MyWindow', 'toolbar=no,location=no,directories=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=500,height=500');
                                        return false;"><?php echo $rows['name'] ?></a><br>
                                                                                                  <?php
                                                                                              }
                                                                                              ?>
    ...
    if ($maincontrol == 'lunch_and_dinner') {
        ...
        <form action="savemenu.php" method="post">
            ...
            <div style="float:right; width: 395px;">
                <fieldset>
                    <legend>MAIN COURSE Beef</legend>
                    <?php
                    include('connect.php');
                    $asas = $_GET['id'];
                    $cffcf = 'beef';
                ...
                <fieldset>
                    ...
                    for ($i = 0; $rows = $result->fetch(); $i++) {
                        ...
                        <a style="text-decoration: none; color: #000000;" href="#" onClick="MyWindow = window.open('details.php?id=<?php echo $rows['id'] ?>', 'MyWindow', 'toolbar=no,location=no,directories=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=500,height=500');
                                        return false;"><?php echo $rows['name'] ?></a>
                        <br>
                        <?php
                    }
                    ?>
    ...
    if ($maincontrol == 'specialty') {
        ...
        <form action="savemenu.php" method="post">
            ...
            <fieldset>
                ...
                ?>
                <input type="button" class="my_form-check-button" onClick="checkAll(true);" value="Pilih Semua"/>
                <input type="button" class="my_form-check-button" onClick="checkAll(false);" value="Kosongkan PIlihan"/>
